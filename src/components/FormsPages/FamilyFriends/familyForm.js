...
const FamilyTherapyForm = () => {
  ...
  const validateStep = () => {
    ...
    // Step 1 validation
    if (currentStep === 1) {
      if (!formData.name || !formData.name.trim()) newErrors.name = "Your name is required";
      if (!formData.participantsNames || !formData.participantsNames.trim()) newErrors.participantsNames = "Other participants' names are required";
      ...
      if (!formData.profession) newErrors.profession = "Your profession is required";
      if (!formData.relationshipType) {
        newErrors.relationshipType = "Relationship type is required";
      } else if (formData.relationshipType === 'Other' && (!formData.otherRelationshipType || !formData.otherRelationshipType.trim())) {
    ...
    // Step 2 validation
      ...
      if (formData.primaryConcern === 'Other' && (!formData.otherPrimaryConcern || !formData.otherPrimaryConcern.trim())) {
      ...
      } else if (formData.therapyGoals.includes('Other') && (!formData.otherTherapyGoal || !formData.otherTherapyGoal.trim())) {
        newErrors.otherTherapyGoal = "Please specify your therapy goal";
      }
      if (!formData.previousTherapy) newErrors.previousTherapy = "Please select an option";
    }
    ...
    const isStepComplete = () => {
      ...
      switch (currentStep) {
        case 1:
          ...
          if (formData.relationshipStatus === "Other" && 
              (!formData.otherRelationshipStatus || !formData.otherRelationshipStatus.trim())) return false;
          return true;
          
        case 2:
          if (!formData.primaryConcern) return false;
          if (formData.therapyGoals.length === 0) return false;
          if (formData.therapyGoals.includes("Other") && 
              (!formData.otherTherapyGoal || !formData.otherTherapyGoal.trim())) return false;
          return true;
          
        case 3:
          if (!formData.previousTherapy) return false;
          if (!formData.preferredLanguage) return false;
          if (formData.preferredLanguage === "Other" && 
              (!formData.otherLanguage || !formData.otherLanguage.trim())) return false;
          return true;
      ...
      case 1:
        return (
          <div className="form-step-MN form-step-1-MN">
            ...
            <p className="form-subtitle-MN">Please provide details about you and other participants.</p>
            <div className='oneLineDetail'>
            <div className="form-field-MN fieldWidthName">
              <label>Your Name <span className="required-field">*</span></label>
              <input
                type="text"
                name="name"
                value={formData.name}
            ...
            <div className="form-field-MN fieldWidthName">
              <label>Name of Other Participant <span className="required-field">*</span></label>
              <input
                type="text"
            ...
            <div className="form-field-MN">
              <label>Your Profession <span className="required-field">*</span></label>
              <select
                name="profession"
            ...
            <div className="form-field-MN ">
              <label>What relationship do you share with the other participant? <span className="required-field">*</span></label>
              <select
            ...
            {formData.profession === 'Other' && (
              <div className="form-field-MN">
                <label>Please specify your Profession <span className="required-field">*</span></label>
                <textarea
                  ...
                  rows="1"
                  className={errors.otherRelationshipType ? 'error-input' : ''}
                ></textarea>
            ...
            {formData.relationshipType === 'Other' && (
              <div className="form-field-MN">
                <label>Please specify your relationship <span className="required-field">*</span></label>
                <textarea
                  name="otherRelationshipType"
                  value={formData.otherRelationshipType}
                  onChange={handleChange}
   ...
   case 2:
    return (
      <div className="form-step-MN form-step-2-MN">
        ...
        <p className="form-subtitle-MN">Tell us about your concerns and goals for therapy.</p>
        
        <div className="form-field-MN">
          <label>Primary Concern / Reason for Therapy <span className="required-field">*</span></label>
          <select
            name="primaryConcern"
        ...
        {formData.primaryConcern === 'Other' && (
          <div className="form-field-MN">
            <label>Please specify your primary concern <span className="required-field">*</span></label>
            <textarea
        ...
        <div className="form-field-MN">
  <p className="form-label-MN">What are your goals for this therapy? <span className="required-field">*</span></p>
  <select
    name="therapyGoals"
  ...
  >
    <option value="" disabled>Select your therapy goal</option>
  ...
  {renderError('therapyGoals')}
        ...
        {formData.therapyGoals.includes('Other') && (
          <div className="form-field-MN">
            <label>Please specify your therapy goal <span className="required-field">*</span></label>
            <textarea
        ...
        <div className="form-field-MN">
          <p className="form-label-MN">Have you or other participants attended therapy before? <span className="required-field">*</span></p>
          <div className={`radio-group-MNIM  ${errors.previousTherapy ? 'error-border' : ''}`}>
            {['Yes', 'No'].map(option => (
              <div 
                key={option}
                className={`radio-option-MN ${formData.previousTherapy === option ? 'selected' : ''}`}
                onClick={() => handleRadioChange('previousTherapy', option)}
              >
                <div className="radio-circle-MN">
                  {formData.previousTherapy === option && <div className="radio-dot-MN"></div>}
                </div>
                <span>{option}</span>
              </div>
            ))}
  ...
  case 3:
    return (
      <div className="form-step-MN form-step-3-MN">
        ...
        <p className="form-subtitle-MN">Please provide your preferences for the therapy session.</p>
        
        <div className='oneLineDetail'>
        <div className="form-field-MN">
          <p className="form-label-MN">Preferred language for the session <span className="required-field">*</span></p>
          <div className={`radio-group-MNIM ${errors.preferredLanguage ? 'error-border' : ''}`}>
        ...
        <div className="form-field-MN">
          <p className="form-label-MN">
            Preferred time for the session <span className="required-field">*</span>
          </p>
          <div className={`dropdown-container-MN ${errors.sessionTime ? 'error-border' : ''}`}>
            <select
        ...
        <div className="form-field-MN">
          <p className="form-label-MN">Do any participants have medical or emotional concerns that may impact the session? <span className="required-field">*</span></p>
          <div className={`oneLineDetail ${errors.medicalConditions ? 'error-border' : ''}`}>
            {['Yes', 'No'].map(option => (
              <div 
                key={option}
        ...
        <div className="form-field-MN fieldWidthPro">
          <label>How did you hear about us? <span className="required-field">*</span></label>
          <select
            name="referralSource"
  ...
  case 4:
    return (
      <div className="form-step-MN form-step-4-MN">
        ...
        <p className="form-subtitle-MN">Select your preferred payment method and agree to terms.</p>
        
        <div className="form-field-MN">
  <label className="form-label-MN" htmlFor="paymentMethod">
    Choose a payment method: <span className="required-field">*</span>
  </label>
  
  <select
    id="paymentMethod"
    name="paymentMethod"
    className={`dropdown-select-MN ${errors.paymentMethod ? 'error-border' : ''}`}
  ...
  {renderError('paymentMethod')}
        ...
        <div className="pricing-info-MN">
          ...
          <p className="fee-description-MN">One-hour online family therapy session</p>
        ...
        <div className="form-field-MN terms-container-MN">
          <label className="terms-label-MN">
            ...
            /> I hereby give my informed consent for the release of written and/or verbal information related to my confidential file in case of threat to myself, or others. I agree to accept and follow the rules of time and regularity needed for the counseling. It is my understanding that the Counselor will maintain professional responsibility towards me.
            </span>
          </label>
    ...
    return (
      <div className="form-step-MN form-step-5-MN">
        <div className="thank-you-MN">
          ...
          <p className="form-subtitle-MN">Your family therapy session has been scheduled successfully.</p>
          ...
          <div className="confirmation-details-MN">
            ...
            <p>One of our therapists will contact you shortly to confirm the exact date and time.</p>
          </div>
          ...
          <div className="next-steps-MN">
            ...
            <ul>
              ...
              <li>Ensure all participants are informed about the session</li>
          ...
          <div className="contact-info-MN">
            ...
            <p><strong>family@therapysupport.com</strong> or call <strong>+91 800-123-4567</strong></p>
          </div>
        </div>
      </div>
    );
