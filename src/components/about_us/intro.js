...
const IntroBox = () =>{
    return (
        ...
        <>
        <div className="overlayintro"></div>
<div className="containerintro">
  <div className="layout">
    ...
    <div className="shapescolumn">
      <div className="recbottomright"></div>
      <div className="squareupperright"></div>
      <div className="recupperleft"></div>
      <div className="squarebottomleft"></div>
    </div>
  </div>
</div>
      </>
