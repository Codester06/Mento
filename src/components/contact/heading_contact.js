...
const ContactSection = () => {
  return (
    <div className="contact-container">
      <div className="above-container-cu">\</div>
      <div className="header-con">
        <h2 className="title-con">
      ...
      <div className="contact-grid">
        ...
        <div className="contact-item">
          ...
          <p className="contact-primary">
            Mento, 502, GR Sankalpa, Kasavanahalli Road Bengaluru.
          </p>
          <p className="contact-primary">560035</p>
          <p className="contact-secondary">
            drop in between 10 AM - 8 PM on any weekday!
          </p>
        </div>
        ...
        <div className="contact-item">
          ...
          <p className="contact-primary">
            <a href="tel:+919120719120">+91 9120719120</a>
          </p>
